...
export default function AdmKamusUpdate() {
  const { id } = useParams();
  const { singleData: kamus, getKamusById, updateKamus, loadPage, errPage, loadUpdate } = useKamus();
